...
export type EodPreferences = {
  ...
  /**
   * Локальные минуты от полуночи (0–1439), когда отправить **одно** напоминание Web Push пройти ритуал EOD за **сегодня**,
   * если ритуал ещё не отмечен. Если поле отсутствует — напоминание не планируется.
   */
  pushReminderMinutesFromMidnight?: number
}
