...
function AppPageInner() {
  const { vault, remoteError, addTask, toggleTask, removeTask } = useVault()
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-lg flex-col px-4 py-8">
      ...
      >
        <input
          className="flex-1 rounded-lg border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm text-white outline-none focus:ring-2 focus:ring-emerald-500/80"
          ...
          >
            <label className="flex flex-1 cursor-pointer items-start gap-3">
              <input
                ...
                className="mt-1 h-4 w-4 rounded border-zinc-600 bg-zinc-900 text-emerald-500"
              />
              <span
