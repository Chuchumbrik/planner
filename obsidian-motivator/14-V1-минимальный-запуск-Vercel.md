...
1. **PWA** — Vite PWA plugin, manifest, базовый offline-кэш shell (полная офлайн-логика данных — см. [[13-Черновики-решений]]).
2. **Надёжность vault** — индикатор «синхронизировано», защита от гонки первой загрузки/сохранения; при необходимости TanStack Query.
